...
(15, 'dokter', 'Semarang', '112233', 4, '112233', '$2y$10$DGwjPe/.2EynnAiJa68IqO4UZfe.u7LeWoS/M3QxvPHUo4oDdyV/K'),
(16, 'Dokter 2', 'Jakarta', '009988', 5, '009988', '$2y$10$N.vlddoVPwPXwYKfRs9ki.tyRr0w4l1uEF8lzj/6b9QRC2NYXHDem');
...
(1, 'Panadol', 'tablet', 11000),
(2, 'OBH Combi', 'Syrup', 14000),
(4, 'Bodrex', 'Tablet', 8000),
(5, 'Bodrexin', 'Syrup', 6000);
...
(31, 'Test', 'Semarang', '123456', '123456', '2023121'),
(32, 'Pasien 1', 'Jogja', '0099', '0099', '20231232');
...
(4, 'poli mata', 'test'),
(5, 'poli THT', 'Telinga Hidung Dan Tenggorokan');
...
(3, 'admin', 'adminbaru', '$2y$10$qckEk6AOrt8XoDLq8FOFM.89VRPTrp/srhtPmPvgF.7MCyZNiN4i2'),
(5, 'admin', 'admin', '$2y$10$W7Npzs.yX2y3NqxyIryZSONgIVaGPw7ORTsxM/lPGJ8t/MzpQVUrW'),
(6, '', 'test', '$2y$10$24bNFD5FiKYN7jI5JLS04uptDNierf1oQii8q1C88zWNhMrVyKeKe');
